...
def get_answer(user_question):
    ...
    if any(word in question for word in goodbye_words):
        return (
            "Au revoir ! J'espère avoir pu t'aider. N'hésite pas si tu as d'autres questions sur le Samsung Galaxy S26 Ultra.",
            1.0,
        )
    ...
    if re.search(ai_pattern_check, question):
        ...
        return (
            "Galaxy AI intègre des outils de retouche photo et des assistants intelligents.",
            1.0,
        )
